...
export const PlantsAtlas = () => {
    const arrMock = [1,2,3];
    const plantDescriptionMock = 'Odmiana Fascinator Tricolor jest jedną z ciekawszych odmian barwnych maranty. Ta roślina doniczkowa tworzy gęsto ulistnione kępy sięgające 30 cm wysokości. Jej piękne, jajowate liście mają aksamitną fakturę i przykuwającą wzrok kolorystykę. Układają się regularnie w zwartą kępę z krótkimi pędami. Spód liści jest purpurowy, zewnętrzna strona natomiast wielobarwna. Ciemna zieleń powierzchni liści przeplata się z jasną, a wzdłuż głównych nerwów biegną jaskrawo pomarańczowe, kontrastujące wzory o łukowym rysunku. Środek każdego liścia zdobiony jest dodatkowo jasnymi akcentami. Wśród liści pojawiają się drobne, białe kwiaty praktycznie przez cały rok, jednak główną ozdobę stanowią barwne liście.'    
